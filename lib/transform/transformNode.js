...
import { StringInput, NumericalInput,
		 Dropdown, UnorderedList, Toggle } from "../input/input";
...
const TransformNodeSettingsContainer = (function(){
	...
	return class extends NodeSettingsContainer {
		...
		_createDOM() {
			...
			this._root.appendChild(list.root);
...
const Transform = (function(){
	...
	return class {
		...
		_createRange() {
			...
			this._root.appendChild(this._range.root);
		}
		...
		_createAngle(bounds) {
			...
			this._root.appendChild(this._angle.root);
		}
